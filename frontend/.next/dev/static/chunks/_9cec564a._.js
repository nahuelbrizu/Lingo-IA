...
"[project]/app/services/EventBus.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/services/AudioOutputManager.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$EventBus$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/services/EventBus.ts [app-client] (ecmascript)");
;
    ...
    async play(request) {
        ...
        try {
            ...
            const handlePlaybackEnd = (isError = false, errorMessage)=>{
                ...
                this.clearWatchdog();
                if (!isError) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$EventBus$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["globalEventBus"].publish({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$AudioOutputManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/services/AudioOutputManager.ts [app-client] (ecmascript)");
...
const useAudioStreaming = (authToken)=>{
    ...
    const generationIdRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const cleanup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAudioStreaming.useCallback[cleanup]": ()=>{
            ...
            if (sessionIdRef.current) __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$AudioOutputManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioOutputManager"].stop(sessionIdRef.current);
            if (wsRef.current) {
    ...
    const conversationStateRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(conversationState);
            ...
            switch(message.type){
                ...
                case 'ai_audio_chunk':
                    if (sessionIdRef.current && generationIdRef.current) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$AudioOutputManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["audioOutputManager"].play({
                            chunk: audioChunk,
    ...
    const startConversation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAudioStreaming.useCallback[startConversation]": ()=>{
            if (conversationStateRef.current === 'idle') {
                sessionIdRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])();
                setChatMessages([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAudioStreaming.useEffect": ()=>cleanup
    }["useAudioStreaming.useEffect"], [
        cleanup
    ]);
...
_s(useAudioStreaming, "2imXRZP1t0FSBRKUJToq+121qKk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_9cec564a._.js.map